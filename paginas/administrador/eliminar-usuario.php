...
<html>
	...
	<body>
		...
		<a>
			<div class="w3-half">
				<div class="w3-card w3-container" style="min-height:460px">
					...
					<b>
						<p>
						Rellena esto con el id del usuario ha eliminar.
						</p>
					</b>
					
					<form class="w3-animate-right w3-large "  action="eliminarusuario.php" method="POST">
					
						<label for="id_articulo">Indica el id del usuario</label><br>
						<input type="text" id="idusuario" class="fadeIn second " name="idusuario" placeholder="Id del usuario"><br><br>
		...
		<?php
			...
			$delete = "DELETE FROM almacenes.usuarios WHERE `idUsuario` = '$idusuario';";
			...
			<div class="w3-half">
				<div class="w3-card w3-container" style="min-height:460px">
					...
					<form class="w3-animate-right w3-large "  action="eliminaralmacen.php" method="POST">
						...
						$consulta = "SELECT `usuarios`.*, `perfil`.`permisos`
									FROM `usuarios` 
									LEFT JOIN `perfil` ON `usuarios`.`idPerfil` = `perfil`.`idPerfil` ";
